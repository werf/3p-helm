...
import (
	...
	"helm.sh/helm/v3/pkg/werfcompat/secret"
	"sigs.k8s.io/yaml"
...
func GetDefaultSecretValuesFile(loadedChartFiles []*loader.BufferedFile) *loader.BufferedFile {
...
func GetSecretDirFiles(loadedChartFiles []*loader.BufferedFile) []*loader.BufferedFile {
...
func LoadChartSecretValueFiles(
	chartDir string,
	secretDirFiles []*loader.BufferedFile,
...
func LoadChartSecretDirFilesData(
	chartDir string,
	secretFiles []*loader.BufferedFile,
	encoder *secret.YamlEncoder,
